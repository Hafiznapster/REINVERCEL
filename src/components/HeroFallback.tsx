  ...
  return (
    <section id="home" className="hero-section position-relative" style={{ minHeight: '100vh', paddingTop: '80px' }}>
      ...
      <div 
        ...
        style={{ 
          background: 'linear-gradient(135deg, rgba(51, 96, 33, 0.9) 0%, rgba(74, 171, 61, 0.8) 100%), url("https://images.unsplash.com/photo-1509391366360-2e959784a276?ixlib=rb-4.0.3&auto=format&fit=crop&w=1744&q=80") center/cover',
          zIndex: -2
        }}
      />
